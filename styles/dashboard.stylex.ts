...
export const dashboardStyles = stylex.create({
  ...
  statWhite: { backgroundColor: colors.background },
  ...
  activityMetric: { display: 'grid', gap: 3 },
  activityPreview: {
    backgroundColor: colors.tertiaryMuted,
    borderRadius: radius.md,
    color: colors.primary,
  ...
  dashboardGrid: {
    ...
    '@media (max-width: 1100px)': { gridTemplateColumns: 'repeat(6, minmax(0, 1fr))' },
  ...
  gridRecent: {
    gridColumn: 'span 7',
    minWidth: 0,
    '@media (max-width: 1100px)': { gridColumn: 'span 6' },
    '@media (max-width: 700px)': { gridColumn: 'auto' },
  },
  gridPlans: {
    gridColumn: 'span 5',
    minWidth: 0,
  ...
  gridAttendance: { gridColumn: '1 / -1', minWidth: 0 },
  sectionCard: {
    backgroundColor: colors.primarySoft,
    borderRadius: radius.card,
  ...
  sectionCardAccent: { backgroundColor: colors.accentSoft },
  statCard: {
    backgroundColor: colors.background,
    borderRadius: radius.card,
    display: 'flex',
  ...
  feed: { display: 'grid', gap: spacing.sm, maxWidth: 860 },
  timeline: {
    display: 'grid',
    gap: spacing.lg,
    maxWidth: 860,
  ...
  weeklyTimelineHeader: {
    display: 'grid',
    gap: 1,
    gridTemplateColumns: '220px repeat(7, minmax(112px, 1fr))',
    minWidth: 1000,
    padding: spacing.sm,
  },
  weeklyTimelineDate: {
  ...
  weeklyRow: {
    ...
    '@media (max-width: 640px)': {
      gridTemplateColumns: '180px repeat(7, minmax(112px, 1fr))',
    },
  },
  weeklyClassName: {
    alignItems: 'center',
  ...
  timelineCount: { color: colors.textMuted, fontSize: fontSize.xs },
  teachingBoard: {
    backgroundColor: colors.background,
    borderColor: colors.secondaryMuted,
    borderRadius: radius.lg,
  ...
  attendanceDetails: { display: 'grid', gap: spacing.xs, minWidth: 0 },
  attendanceName: { color: colors.primary, fontWeight: 800 },
  attendanceClass: { color: colors.textMuted, fontSize: fontSize.sm },
  attendanceMeta: {
    alignItems: 'flex-end',
    color: colors.textMuted,
    display: 'grid',
  ...
  attendanceVisits: { color: colors.primary, fontWeight: 700 },
  publishButton: {
    borderRadius: radius.pill,
    justifySelf: 'center',
    minHeight: 32,
