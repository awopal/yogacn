...
const styles = stylex.create({
  ...
  xs: { fontSize: fontSize.xs, minHeight: 24, paddingBlock: spacing.xs, paddingInline: spacing.sm },
  sm: { fontSize: fontSize.sm, minHeight: 34, paddingBlock: spacing.xs, paddingInline: spacing.sm },
